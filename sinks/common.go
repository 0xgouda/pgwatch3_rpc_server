...
func GetJson[K map[string]string | map[string]any | float64 | *structpb.Struct | []*structpb.Struct](value K) string {
...
func Listen(receiver pb.ReceiverServer, port string) error {
